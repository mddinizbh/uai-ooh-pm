...
| Task | O que | Nota |
|---|---|---|
| [RECAL-00](RECAL-00-hll-audiencia-hex.md) | **HLLs de audiência por hex no Redis** (PFADD da base OD) — insumo do **alcance ao vivo com dedup** do CONS-05 | pode rodar JÁ (só depende da base OD ✅) |
...
| [RECAL-02](RECAL-02-validacao-reconciliacao.md) | **validação/reconciliação** na 4107: medido vs estimado, incremental vs agregado (impressões e alcance-HLL), selos ADR-058 | counts via MCP `postgres-ooh` |
