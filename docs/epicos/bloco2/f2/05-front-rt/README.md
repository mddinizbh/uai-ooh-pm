...
> Repo: **`uai-portal`** *(estende o módulo OOH do F1)* · **mapa universal** + mapa ao vivo (carros + alcance subindo) + painel verificado vs estimado.
...
| [WEB-01](WEB-01-mapa-ao-vivo.md) | **mapa ao vivo**: carros se movendo **+ contador de alcance subindo** (acumulado parcial, selo estimativa), escopável por linha | camadas do WEB-00 · hook `usePositions(scope)` (polling; swappable) |
...
**Pronto:** o planejador vê os carros de uma linha ao vivo com o alcance acumulando + o quanto o
