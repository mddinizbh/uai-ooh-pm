...
> **Depende de:** EP4-06 (cesta) + EP4-01 (`ProposalPort`) · **Paralelizável:** parcial
...
## Conteúdo do PDF
- **Capa** (cliente, BH Bus, data) + **linhas da cesta** (ficha resumida cada) + **COMBINADO** + **disclaimer de honestidade** (impressões = estimativa ±35% / OTS, não pessoas únicas; ranking é o defensável; vigências).
